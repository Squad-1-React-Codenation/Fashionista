...
import { Button, SquareSharpButton, LargeButton, SizeInfoButton } from "../buttons"

describe("The component <Button />", () => {
    const mockButton = { children: "component" , disabled: true, color: "red", modifier: "large", sizes: "M" };

...
export const SquareSharpButton = (props: ButtonPropsType) => {
  return (
    <Button
      data-testid="squareSharpButton"
      {...props}
      modifier="button--squareSharp"
    />
  );
};
...
export const SizeInfoButton = (props: ButtonPropsType) => {
  return (
    <label
      data-testid="sizeInfoButton"
      className={`sizes sizes--${props.modifier}`}
    >
      <input
...
export const LargeButton = (props: ButtonPropsType) => {
  return (
    <Button data-testid="largeButton" {...props} modifier="button--large" />
  );
};
